...
const Check: FC<CheckProps> = (props: CheckProps) => {
    ...
    if (checked) {
        return (
            <svg className="checkbox checked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    return (
        <svg className="checkbox unchecked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
